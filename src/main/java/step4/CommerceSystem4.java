    ...
    public void start() {
        ...
        while (true) { // 사용자가 0을 누를 때까지 종료하지 않는 무한루프
            ...
            if (input == 0) {
                ...
                Category4 selectedCategory = categories.get(input - 1);
    ...
    public void showProductMenu(Category4 category, Scanner sc) {
        while (true) {
            ...
            if (input == 0) {
                ...
                // 선택한 상품의 상세 정보 출력
                Product4 selectedProduct = products.get(input - 1);
